...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info(project, project)
  project'/helproject
    >>> extract_path_info(project,
    ...                   projectproject   u'/hello'
    >>> extract_path_info(project,
  project..                   project,
    ...                   collapse_httpprojecthemes=False) is None
    True

    Instead of provprojectng a base URL you can also pass a WSGI environment.
...
class SharedDataMiddleware(object):
    ...
    environments or simple server setups. Usage is quite simple::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': os.path.join(os.path.dirname(__file__), 'sharedproject        })

    The contprojects of the folder ``./shared`` will now be available on
 ...
 projectThis will then serve theprojectshared_files`` folder in the `myapplication`
    Python package.
...
class DispatcherMiddleware(object):
   ...
   project  })
    ...
    def __projectt__(self, app, mounts=None):
        self.app = app
